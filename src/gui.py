...
with tab2:
    # Afficher la documentation du projet (README.md)
...
with tab3:
    # Afficher les détails théoriques (algorithm_details.md)
    st.header("Détails Théoriques : Méthode de Levenberg-Marquardt")
    with open("docs/algorithm_details.md", "r", encoding="utf-8") as file:
        algorithm_details_content = file.read()
    st.markdown(algorithm_details_content)